...
function Home() {
  ...
  const featuredCards = [
    { _id: 'cz', name: 'Charizard', img_name: 'images/Charizard.png', type: 'Fire', hp: '180' },
    { _id: 'pk', name: 'Pikachu V', img_name: 'images/Pikachu V.jpg', type: 'Electric', hp: '190' },
    { _id: 'bl', name: 'Blastoise', img_name: 'images/Blastoise.png', type: 'Water', hp: '180' }
  ];
      ...
      <div className="featured-cards-section">
        ...
        <div className="featured-cards-container">
           {featuredCards.map(card => (
             <Card
               key={card._id}
               image={`/${card.img_name}`} // Adjusted path assuming root images folder
               title={card.name}
